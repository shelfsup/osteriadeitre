...
<div class="d-flex justify-content-center flex-column align-items-center mt-1" style="height: 30vh">
                ...
                <div style=" border-radius: 12px;  background-size: cover; background-blend-mode: multiply;" id="collapse{{ $categoria->id }}" class="accordion-collapse collapse" :class="{ 'show': open }" aria-labelledby="heading{{ $categoria->id }}" data-bs-parent="#menuAccordion">
                    <div class="accordion-body">
                        @foreach ($categoria->piatti as $piatto)
                            <div class=" py-2 tabella-piatto" style="border-bottom: 1px solid var(--bg-border-bottom-piatto);" data-lingua="{{ $selectedLanguage }}" data-piatto-id="{{ $piatto->id }}" data-asporto="{{ true }}" style="width: 100%;">
                                <div class="d-flex justify-content-start align-items-center gap-2">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center px-2">
                                        @if (fmod($piatto->prezzo_asporto, 1) == 0)
                                            <p class="piatto-prezzo ps-2  fs-md-5 fs-6">{{ number_format($piatto->prezzo_asporto, 0, ',', '.') }}€</p>
                                        @else
                                            <p class="piatto-prezzo ps-2  fs-md-5 fs-6">{{ number_format($piatto->prezzo_asporto, 2, ',', '.') }}€</p>
                                        @endif
                                    </div>
                                    @if ($piatto->photo)
                                        <div>
    ...
    <div class="mt-5 d-flex justify-content-center align-items-center flex-column">
        @if ($selectedLanguage == 'it')
            <h1 class="text-center fs-1" style="font-family: 'FelixTitlingRegular', sans-serif;">chiama</h1>
        @else
            <h1 class="text-center fs-1" style="font-family: 'FelixTitlingRegular', sans-serif;">call us</h1>
        @endif
        <a href="tel:0651841237" target="_blank" class="btn btn-secondary text-center fs-3" style="width: fit-content !important; font-family: 'FelixTitlingRegular', sans-serif;">06 5184 1237</a>
    </div>
