...
<head>
    ...
    {{-- <script type="text/javascript" src="https://cs.iubenda.com/autoblocking/3621084.js"></script>
    ...
    @vite(['resources/css/theme_settings.css'])
    <!-- Styles -->
    <style>
        [data-theme="light"] {
            --color-text: #2d2d2d;
            /* Colore del testo */
            --color-text-tooltip: #1a1a1a;
            /* Colore del testo del tooltip */
            --color-text-danger: #d9534f;
            /* Colore del testo per il pericolo */
            --color-text-success: #5a7d9a;
            /* Colore del testo per il successo */
            --bg-body: #dadada;
            /* Sfondo del corpo */
            --bg-custom-red: #d9534f;
            /* Rosso personalizzato */
            --bg-White: #e9ecef;
            /* Grigio chiaro */
            --bg-sidebar: linear-gradient(to right top, #5a7d9a, #4e6c8e);
            --bg-custom-card-header: linear-gradient(to right top, #d6d6d6, #f0f0f0);
            /* Sfondo dell'intestazione della card */
            --bg-custom-card: linear-gradient(to right top, #ffffff, #f0f0f0);
            /* Sfondo della card */
            --bg-button-1: #5a7d9a;
            /* Colore del bottone 1 */
            --bg-button-2: #a7bcd2;
            /* Colore del bottone 2 */
            --bg-button-3: #d9534f;
            /* Colore del bottone 3 */
            --bg-button-4: #f0ad4e;
            /* Colore del bottone 4 */
            --bg-input: #e2e6e9;
            /* Sfondo dell'input */
            --bg-select: #e2e6e9;
            /* Sfondo della selezione */
            --shadow-1: rgba(0, 0, 0, 0.1) 0px 4px 6px;
            /* Ombra 1 */
            --shadow-2: rgba(0, 0, 0, 0.15) 0px 6px 6px;
            /* Ombra 2 */
            --shadow-3: rgba(0, 0, 0, 0.2) 0px 10px 15px;
            /* Ombra 3 */
            --bg-lightgreen: #a3b6c6;
            /* Blu chiaro */
            --bg-lightgreen2: #aab8c4;
            /* Blu chiaro 2 */
            --bg-lightgreen3: #d0dce6;
            /* Blu chiaro 3 */
            --bg-None: rgba(255, 255, 255, 0);
            /* Sfondo trasparente */
            --bg-toggle-spese-fisse: #d9534f;
            /* Colore del toggle delle spese fisse */
            --loader-custom: #5a7d9a;
            /* Colore del loader */
            --loader-custom-before: #4e6c8e;
            /* Colore del loader prima */
            --loader-custom-after: #5a7d9a;
            /* Colore del loader dopo */

            --task-non-iniziato: #e9ecef;
            /* Task non iniziato */
            --task-in-corso: #5a7d9a;
            /* Task in corso */
            --task-in-attesa: #ffb74d;
            /* Task in attesa */
            --task-completato: #5a9a7a;
            /* Task completato */
            --checkbox-false: #adb5bd;
            /* Checkbox falso */
            --checkbox-true: #5a9a7a;
            /* Checkbox vero */
        }
        ...
        [data-theme="dark"] {
            ...
            --bg-White: #46424f;
            /* Grigio scuro */
            --bg-sidebar: linear-gradient(to right bottom, #46424f, #393541);
            /* Sfondo della barra laterale */
            --bg-custom-card-header: linear-gradient(to right top, #3a3a3a, #2b2b2b);
            /* Sfondo dell'intestazione della card */
            --bg-custom-card: linear-gradient(to right top, #3a3a3a, #1b1b1b);
            /* Sfondo della card */
            --bg-button-1: #9171f8;
            /* Colore del bottone 1 */
            --bg-button-2: #a688fa;
            ...
            --bg-button-4: #f0ad4e;
            /* Colore del bottone 4 */
            --bg-input: #2f2b3a !important;
            /* Sfondo dell'input */
            --bg-select: #2f2b3a !important;
            /* Sfondo della selezione */
            --shadow-1: rgba(0, 0, 0, 0.5) 0px 4px 6px;
            /* Ombra 1 */
            --shadow-2: rgba(0, 0, 0, 0.4) 0px 6px 6px;
            /* Ombra 2 */
            --shadow-3: rgba(0, 0, 0, 0.7) 0px 10px 15px;
            /* Ombra 3 */
            --bg-None: rgba(255, 255, 255, 0);
            /* Sfondo trasparente */
            --bg-lightgreen: #2f2b3a;
            /* Blu chiaro */
            --bg-lightgreen2: #5e5a66;
            /* Blu chiaro 2 */
            --bg-lightgreen3: #2f2b3a;
            /* Blu chiaro 3 */
            --bg-toggle-spese-fisse: #d9534f;
            /* Colore del toggle delle spese fisse */
            --loader-custom: #9171f8;
            /* Colore del loader */
            --loader-custom-before: #7a5af5;
            /* Colore del loader prima */
            --loader-custom-after: #a688fa;
            /* Colore del loader dopo */

            --task-non-iniziato: #4e4e4e00;
            /* Task non iniziato */
            --task-in-corso: #4e4e4e;
            /* Task in corso */
            --task-in-attesa: #ffb74d;
            /* Task in attesa */
            --task-completato: #5a9a7a;
...
<body class="font-sans antialiased">
    <div class="bg-gray-50 text-black/50">
        <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="{{ url('svg/background_home.svg') }}" />
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        ...
                        <h1 style="font-weight: bold">Il Mio Menù</h1>
                    </div>
                    @if (Route::has('login'))
                        <nav class="-mx-3 flex flex-1 justify-end">
                            @auth
                                <div style="background-color: #5a7d9a;" class="flex items-center justify-center rounded-lg">
                            ...
                            @else
                                <div style="background-color: #5a7d9a; margin-right: 5px; box-shadow: 0px 7px 4px 0px rgba(0, 0, 0, 0.126);" class="flex items-center justify-center rounded-lg">
                                ...
                                @if (Route::has('register'))
                                    <div style="background-color: #5a7d9a; box-shadow: 0px 7px 4px 0px rgba(0, 0, 0, 0.126);" class="flex items-center justify-center rounded-lg">
                ...
                {{-- <footer style="position: fixed; bottom: 20px;">
                    <a href="https://www.iubenda.com/privacy-policy/86951968" class="iubenda-white iubenda-noiframe iubenda-embed iubenda-noiframe " title="Privacy Policy ">Privacy Policy</a>
                    <script type="text/javascript">
                        (function(w, d) {
                            var loader = function() {
                    ...
                    <a href="https://www.iubenda.com/privacy-policy/86951968/cookie-policy" class="iubenda-white iubenda-noiframe iubenda-embed iubenda-noiframe " title="Cookie Policy ">Cookie Policy</a>
                    <script type="text/javascript">
                        (function(w, d) {
                            var loader = function() {
                                var s = d.createElement("script"),
