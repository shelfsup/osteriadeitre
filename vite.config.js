    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/app.js',
                'resources/css/menu_theme_settings.css',
                'resources/css/theme_settings.css',
                'resources/css/custom-toast.css',
                'resources/_pwa_conf/manifest.webmanifest'
        ...
        //         lang: "it",
        //         scope: "/",
        //         description: "Il gestionale per la tua casa.",
        //         display: "standalone",
