...
class MenuAsportoOnline extends Component
{
    public $categorie;
    ...
    public function refreshCategories()
    {
        ...
        ->where(function ($query) {
            $query->whereHas('piatti', function ($query) {
                    $query->where('enable', 1)->where('asporto', 1);
                })
    ...
    public function setTitoli()
    {
        ...
        $this->titolo_menu_ita = $testiMenu->titolo_menu_asporto_italiano;
        $this->titolo_menu_eng = $testiMenu->titolo_menu_asporto_inglese;
    ...
    public function saveTitoli()
    {
        ...
        $testiMenu->titolo_menu_asporto_italiano = $this->titolo_menu_ita;
        $testiMenu->titolo_menu_asporto_inglese = $this->titolo_menu_eng;
    ...
    {
        return view('livewire.menu-asporto-online', [
